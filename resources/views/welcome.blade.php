        ...
        <section id="hero" class="hero section dark-background">
            ...
            <div class="hero-background">
                <video autoplay="" muted="" loop="" playsinline="">
                    <source src="user/assets/img/restaurant/video-4.mp4" type="video/mp4">
                </video>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6" data-aos="fade-up">
                        <div class="about-content">
                            ...
                            <div class="signature mt-4" data-aos="fade-up" data-aos-delay="250">
                                ...
                                <img src="user/assets/img/misc/signature-1.webp" alt="Chef Signature"
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="about-gallery">
                            <div class="row g-3">
                                <div class="col-6">
                                    <img src="user/assets/img/restaurant/showcase-3.webp" class="img-fluid rounded"
                                        alt="Restaurant Image">
                                </div>
                                <div class="col-6">
                                    <img src="user/assets/img/restaurant/showcase-8.webp" class="img-fluid rounded"
                                        alt="Restaurant Image">
                                </div>
                                <div class="col-12 mt-3">
                                    ...
                                    <img src="user/assets/img/restaurant/showcase-6.webp" class="img-fluid rounded"
                                        alt="Restaurant Image">
                                </div>
                            </div>
                        </div>
                ...
                <div class="isotope-layout" data-default-filter="*" data-layout="masonry"
                    ...
                    <div class="menu-grid isotope-container row gy-5" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-starters">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="user/assets/img/restaurant/starter-1.webp" alt="Appetizer"
                                        class="img-fluid">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-starters">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="user/assets/img/restaurant/starter-3.webp" alt="Appetizer"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-main">
                            <div class="menu-card featured">
                                <div class="menu-card-image">
                                    <img src="user/assets/img/restaurant/main-2.webp" alt="Main Course"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-main">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="user/assets/img/restaurant/main-6.webp" alt="Main Course"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                                        <span class="badge-vegetarian">V</span>
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-dessert">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="user/assets/img/restaurant/dessert-4.webp" alt="Dessert"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-dessert">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="user/assets/img/restaurant/dessert-9.webp" alt="Dessert"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-drinks">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="user/assets/img/restaurant/drink-2.webp" alt="Beverage"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                        ...
                        <div class="col-xl-4 col-lg-6 isotope-item filter-drinks">
                            <div class="menu-card">
                                <div class="menu-card-image">
                                    <img src="user/assets/img/restaurant/drink-6.webp" alt="Beverage"
                                        class="img-fluid">
                                    <div class="dietary-badges">
                ...
                <div class="chef-recommendations" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="recommendation-card">
                                <div class="recommendation-image">
                                    <img src="user/assets/img/restaurant/main-9.webp" alt="Chef Recommendation"
                                        class="img-fluid">
                        ...
                        <div class="col-lg-6">
                            <div class="recommendation-card">
                                <div class="recommendation-image">
                                    <img src="user/assets/img/restaurant/main-8.webp" alt="Chef Recommendation"
                                        class="img-fluid">
                                    <div class="chef-badge">
                                        <i class="bi bi-award"></i>
                                        <span>Chef's Pick</span>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit
                                    ...
                                    risus at semper.</p>
                                <div class="profile">
                                    <img src="user/assets/img/person/person-m-9.webp" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Enim nisi quem export duis labore cillum quae magna enim sint quorum nulla quem
                                    ...
                                    minim.</p>
                                <div class="profile">
                                    <img src="user/assets/img/person/person-f-5.webp" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Fugiat enim eram quae cillum dolore dolor amet nulla culpa multos export minim fugiat
                                    ...
                                    labore.</p>
                                <div class="profile">
                                    <img src="user/assets/img/person/person-f-12.webp" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Quis quorum aliqua sint quem legam fore sunt eram irure aliqua veniam tempor noster
                                    ...
                                    culpa.</p>
                                <div class="profile">
                                    <img src="user/assets/img/person/person-m-12.webp" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Export tempor illum tamen malis malis eram quae irure esse labore quem cillum quid
                                    ...
                                    legam anim culpa.</p>
                                <div class="profile">
                                    <img src="user/assets/img/person/person-m-13.webp" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <p>Texit tempor illum tamen malis malis eram quae irure esse labore quem cillum quid
                                    ...
                                    legam anim culpa.</p>
                                <div class="profile">
                                    <img src="user/assets/img/person/person-f-13.webp" class="testimonial-img"
                                        alt="" loading="lazy">
                                    <div class="info">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="featured-chef row align-items-center g-4" data-aos="fade-up" data-aos-delay="150">
                    <div class="col-lg-5">
                        <figure class="chef-photo m-0">
                            <img src="user/assets/img/restaurant/chef-4.webp" alt="Executive chef portrait"
                                class="img-fluid">
                ...
                <div class="row g-4 team-grid mt-2">
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
                        <article class="chef-card h-100">
                            <div class="image-wrapper">
                                <img src="user/assets/img/restaurant/chef-1.webp" alt="Sous chef portrait"
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="250">
                        <article class="chef-card h-100">
                            <div class="image-wrapper">
                                <img src="user/assets/img/restaurant/chef-6.webp" alt="Pastry chef portrait"
                                    class="img-fluid" loading="lazy">
                                <ul class="social list-unstyled m-0">
                                    <li><a href="#" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                                    </li>
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
                        <article class="chef-card h-100">
                            <div class="image-wrapper">
                                <img src="user/assets/img/restaurant/chef-8.webp" alt="Grill chef portrait"
                                    class="img-fluid" loading="lazy">
                                <ul class="social list-unstyled m-0">
                                    <li><a href="#" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                                    </li>
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="350">
                        <article class="chef-card h-100">
                            <div class="image-wrapper">
                                <img src="user/assets/img/restaurant/chef-3.webp" alt="Line cook portrait"
                                    class="img-fluid" loading="lazy">
                                <ul class="social list-unstyled m-0">
                                    <li><a href="#" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                                    </li>
                                ...
                                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
                                    <div class="reservation-info-section">
                                        <div class="hero-image">
                                            <img src="user/assets/img/restaurant/showcase-2.webp"
                ...
                <div class="row g-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                    <div class="col-lg-6" data-aos="slide-right" data-aos-delay="250">
                        <div class="feature-card primary">
                            <div class="feature-visual">
                                <img src="user/assets/img/restaurant/misc-3.webp" alt="Special Menu"
                                    class="img-fluid">
                    ...
                    <div class="col-lg-6" data-aos="slide-left" data-aos-delay="300">
                        <div class="feature-card secondary">
                            <div class="feature-visual">
                                <img src="user/assets/img/restaurant/misc-7.webp" alt="Wine Pairing"
                                    class="img-fluid">
                                <div class="feature-badge">
                    ...
                    <div class="row g-3 isotope-container" data-aos="fade-up" data-aos-delay="200">
                        <div class="col-lg-4 col-md-6 isotope-item filter-food">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/main-3.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/main-3.webp" alt="Grilled Salmon"
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-interior">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/showcase-2.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/showcase-2.webp" alt="Dining Hall"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-staff">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/chef-5.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/chef-5.webp" alt="Chef Maria"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-drinks">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/drink-2.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/drink-2.webp" alt="Signature Mocktail"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-food">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/dessert-4.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/dessert-4.webp" alt="Raspberry Tart"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-interior">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/showcase-5.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/showcase-5.webp" alt="Bar Area"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-staff">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/chef-2.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/chef-2.webp" alt="Sous Chef Daniel"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-drinks">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/drink-8.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/drink-8.webp" alt="Classic Espresso"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
                        ...
                        <div class="col-lg-4 col-md-6 isotope-item filter-food">
                            <figure class="gallery-card">
                                <a href="user/assets/img/restaurant/main-7.webp" class="glightbox"
                                    data-gallery="restaurant-gallery">
                                    <img src="user/assets/img/restaurant/main-7.webp" alt="Beef Fillet"
                                        class="img-fluid rounded" loading="lazy">
                                </a>
                                <figcaption class="caption">
